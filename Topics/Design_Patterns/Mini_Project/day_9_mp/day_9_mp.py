# Applying Observer Pattern and implement it in a stock trading program that has a very well designed architecture all coded from scratch with no AI help
...
if __name__ == "__main__":
    ...
    print("-----------------------------------------------")
    TransactionCenter.buy_order(my_account,apple_market,50)
    print(f"Balance: {my_account.balance}")
    print(f"Shares: {my_account.stocks}")
    print("-----------------------------------------------")
    TransactionCenter.sell_order(my_account, apple_market, 50)
    print(f"Balance: {my_account.balance}")
    print(f"Shares: {my_account.stocks}")
    print("-----------------------------------------------")
